...
<button
	...
	onclick={swirl}
	class="group inline-flex h-10 w-10 items-center justify-center rounded-lg text-(--app-muted) transition hover:bg-(--app-hover) hover:text-(--app-secondary) {triggerClass}"
>
	<i
