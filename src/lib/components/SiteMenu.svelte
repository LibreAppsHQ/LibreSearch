...
{#if open}
	<div use:portal>
		...
		<aside
			class="fixed top-0 right-0 z-50 h-full w-[16rem] overflow-y-auto border-l border-[var(--app-border)] bg-[var(--app-background)] px-5 py-5 shadow-2xl shadow-black/50"
