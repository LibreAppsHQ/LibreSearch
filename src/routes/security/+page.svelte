...
<main class="bg-[var(--app-background)] text-[var(--app-text)]">
	<section class="mx-auto w-full max-w-[900px] px-6 py-12 sm:py-16">
		...
		<p class="mt-4 text-base leading-7 text-[var(--app-muted)]">
			...
			<a class="text-[var(--app-accent)] hover:underline" href="/contact">/contact</a> and pick
			"Security disclosure" as the subject. We'll reply with a secure channel for follow-up if the
			report warrants one.
		</p>
		...
		<p class="mt-6 text-sm italic text-[var(--app-muted)]">No reports yet. Be the first.</p>
